#==============================================================================
# Get-DiskFree function. Concisely returns the disk-space usage of filesystems
# Works on remote computers. Credit where it's due, see remarks.
# This isn't even really a fork, it's barely changed.
#
# Modified: 07/12/2020
# Version: 1.0
# Author: ADAPTED BY - James Britton
#==============================================================================
...
https://binarynature.blogspot.com/2010/04/powershell-version-of-df-command.html - an equivalent to df. Run with -ComputerName and -Format to mimic df -h

.DESCRIPTION

NOT MY SCRIPT. Credit to Marc Weisel and BinaryNature.
